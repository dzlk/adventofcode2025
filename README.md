...
Это личный учебный проект, но идеи и предложения приветствуются!

## 📄 Лицензия

Код проекта: MIT License
Задачи Advent of Code: © Eric Wastl, [adventofcode.com](https://adventofcode.com/)

---

**Удачи с решением задач! 🎄⭐**
